  ...
  return (
    <div>
      ...
      <div className="mt-8 flex flex-col gap-10">
        ...
        {/* Multi-column form */}
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Multi-column layout</h2>
        ...
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Single-column stacked</h2>
          <p className="text-[14px] text-[#505867] dark:text-[#9CA3AF] mb-5 leading-relaxed">
        ...
        {/* Sectioned form */}
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Sectioned form</h2>
          <p className="text-[14px] text-[#505867] dark:text-[#9CA3AF] mb-5 leading-relaxed">
        ...
        {/* Field states */}
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Field states</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* Specs */}
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Field specs</h2>
