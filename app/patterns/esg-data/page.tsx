...
export default function ESGDataPage() {
  return (
    <div>
      ...
      {/* Spectrum overview */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Aspect color map</h2>
      ...
      {/* Metric cards */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Metric card pattern</h2>
      ...
      {/* Rules */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Rules</h2>
