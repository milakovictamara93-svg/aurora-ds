  ...
  return (
    <div>
      ...
      <div className="mt-8 flex flex-col gap-10">
        ...
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Customize view drawer</h2>
        ...
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Behaviour specs</h2>
        ...
        <section>
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white mb-2">Column layout specs</h2>
          <div className="rounded-xl border border-[#EDEEF1] dark:border-[#1F2430] overflow-hidden bg-white dark:bg-[#0D1117]">
