...
export default function AccessibilityPage() {
  return (
    <div>
      ...
      {/* Contrast checker */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Contrast ratios</h2>
      ...
      {/* Focus indicators */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Focus indicators</h2>
      ...
      {/* Keyboard navigation */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Keyboard navigation</h2>
      <div className="overflow-x-auto rounded-xl border border-token mb-10">
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-token-secondary border-b border-token">
      ...
      {/* ARIA patterns */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">ARIA patterns</h2>
      ...
      {/* Checklist */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Accessibility checklist</h2>
