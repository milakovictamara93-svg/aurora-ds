...
export default function BrandVoicePage() {
  return (
    <div>
      ...
      {/* Voice principles */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Voice principles</h2>
      ...
      {/* Capitalisation */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Capitalisation</h2>
      ...
      {/* Button labels */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Button labels</h2>
      ...
      {/* Error messages */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Error messages</h2>
      ...
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Empty state copy</h2>
      ...
      {/* Formatting rules */}
      <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Text formatting rules</h2>
