    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
      ...
      <div className="p-6 rounded-xl border border-token bg-token-primary">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button className="w-full px-4 py-2.5 rounded-lg bg-blue-50 text-blue-600 font-semibold text-sm hover:bg-blue-100 dark:bg-blue-950/50 dark:text-blue-400 transition-colors">
            Secondary action
          </button>
      ...
      <div className="p-6 rounded-xl border border-token bg-token-primary">
        ...
        <div className="flex flex-wrap gap-2">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-semibold bg-blue-50 text-blue-700 dark:bg-blue-950/50 dark:text-blue-300">Blue</span>
      ...
      <div className="p-6 rounded-xl border border-token bg-token-primary">
        ...
        <div className="rounded-lg border border-token overflow-hidden shadow-level-2">
          <div className="bg-blue-600 px-4 py-3">
            ...
            <p className="text-blue-200 text-xs mt-0.5">Q4 2025 · Melbourne CBD</p>
          </div>
      ...
      <div className="p-6 rounded-xl border border-token bg-token-primary">
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            { type: 'info', label: 'Show info', color: 'bg-blue-50 text-blue-700 hover:bg-blue-100' },
        ...
        {toast && (
          <div className={`mt-4 flex items-start gap-2 p-3 rounded-lg text-sm font-medium shadow-level-3 ${
            ...
            {toast === 'info' && <InformationCircleIcon className="w-5 h-5 shrink-0 text-blue-600" />}
