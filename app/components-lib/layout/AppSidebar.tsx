...
const FOUNDATIONS: NavGroup = {
  ...
  items: [
    ...
    { href: '/foundations/borders-shadows', label: 'Effects' },
...
const COMPONENT_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    label: 'Forms',
    items: [
      { href: '/components/inputs/text',              label: 'Text input' },
      { href: '/components/combobox',                  label: 'Combobox' },
      { href: '/components/inputs/select',            label: 'Listbox' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/components/indicator',              label: 'Indicator' },
