    ...
    <div>
      ...
      <div className="mt-8 flex flex-col gap-10">
        ...
        <section>
          ...
          {/* Standard */}
          <p className="text-[14px] font-semibold text-[#505867] dark:text-[#9CA3AF] mb-2">Standard</p>
          ...
          {/* Shadow */}
          <p className="text-[14px] font-semibold text-[#505867] dark:text-[#9CA3AF] mb-2">Shadow</p>
