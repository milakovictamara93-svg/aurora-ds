        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="rounded-xl border border-[#EDEEF1] dark:border-[#1F2430] bg-white dark:bg-[#111827] p-4">
              ...
              <ColumnChart data={MONTHLY} showWarning warningIndex={22} missingFrom={30} labels={['2020', '2021', '2022', '2023', '2024', '2025']} legend={[{ label: 'Energy use intensity', color: CHART_COLORS.barSelected }, { label: 'Missing', color: CHART_COLORS.barDisabled }, { label: 'Warnings', color: CHART_COLORS.warning }]} />
            </div>
            <div className="rounded-xl border border-[#EDEEF1] dark:border-[#1F2430] bg-white dark:bg-[#111827] p-4">
              <p className="text-[12px] font-semibold text-[#505867] dark:text-[#9CA3AF] mb-3">GHG aspect</p>
              <ColumnChart data={MONTHLY.map(v => v * 0.7)} color={CHART_COLORS.ghg} missingFrom={30} labels={['2020', '2021', '2022', '2023', '2024', '2025']} legend={[{ label: 'GHG emissions', color: CHART_COLORS.ghg }, { label: 'Missing', color: CHART_COLORS.barDisabled }]} />
            </div>
            <div className="rounded-xl border border-[#EDEEF1] dark:border-[#1F2430] bg-white dark:bg-[#111827] p-4">
