        ...
        <div className="divide-y divide-token rounded-xl border border-token overflow-hidden bg-token-primary">
          <div className="p-6">
            ...
            <ul className="space-y-2.5 text-sm text-token-secondary">
              <li className="flex items-start gap-2.5"><span className="text-token-muted shrink-0 w-5 mt-px">→</span><span>Always use <strong className="text-token-primary font-semibold">outline</strong> by default — solid only for active/selected states</span></li>
              <li className="flex items-start gap-2.5"><span className="text-token-muted shrink-0 w-5 mt-px">→</span><span>Default size <strong className="text-token-primary font-semibold">24px</strong> (<code className="font-mono text-xs bg-token-secondary px-1 py-0.5 rounded">w-6 h-6</code>), button icons <strong className="text-token-primary font-semibold">20px</strong>, inline text icons <strong className="text-token-primary font-semibold">16px</strong></span></li>
              <li className="flex items-start gap-2.5"><span className="text-token-muted shrink-0 w-5 mt-px">→</span><span>Icon-to-text gap is always <strong className="text-token-primary font-semibold">8px</strong> (<code className="font-mono text-xs bg-token-secondary px-1 py-0.5 rounded">gap-2</code>)</span></li>
              <li className="flex items-start gap-2.5"><span className="text-token-muted shrink-0 w-5 mt-px">→</span><span>Icons inherit color from their parent — never hardcode colors directly on the SVG</span></li>
              <li className="flex items-start gap-2.5"><span className="text-token-muted shrink-0 w-5 mt-px">→</span><span>Decorative icons: <code className="font-mono text-xs bg-token-secondary px-1 py-0.5 rounded">aria-hidden=&quot;true&quot;</code> · Icon-only buttons: <code className="font-mono text-xs bg-token-secondary px-1 py-0.5 rounded">aria-label</code> on the button</span></li>
