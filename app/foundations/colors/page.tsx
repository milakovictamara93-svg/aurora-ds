...
const SECTIONS: PaletteSection[] = [
  ...
  },
  {
    id: 'brand',
    heading: 'Brand',
    description: 'Sky and Emerald are the two brand accent colors — Sky for links and focus states, Emerald for highlights and secondary brand moments.',
    groups: [
      {
        title: 'Sky',
        colors: [
          ...
          { name: 'Sky 500', hex: '#2295FF', token: '--sky-500', textColor: 'light' },
      ...
      },
      {
        ...
        colors: [
          ...
          { name: 'Emerald 300', hex: '#43F9C2', token: '--emerald-300' },
          { name: 'Emerald 400', hex: '#1BECB4', token: '--emerald-400' },
          { name: 'Emerald 500', hex: '#00D39E', token: '--emerald-500', textColor: 'light' },
