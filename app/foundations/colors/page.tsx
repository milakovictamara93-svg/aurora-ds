  ...
  return (
    <div>
      ...
      <div className="mt-12 mb-10 p-6 rounded-xl border border-token bg-token-primary">
        <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4] mb-2">Key usage rules</h2>
      ...
      <div className="mb-10">
        <div className="mb-2">
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4]">Semantic tokens</h2>
      ...
      <div className="mb-10">
        <div className="mb-2">
          <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4]">ESG Aspect colors</h2>
          <p className="text-sm text-token-secondary mt-1">
      ...
      <div className="space-y-14">
        {SECTIONS.map(section => (
          <section key={section.id}>
            <div className="mb-2">
              <h2 className="text-[20px] font-semibold text-[#111827] dark:text-white leading-[1.4]">{section.heading}</h2>
