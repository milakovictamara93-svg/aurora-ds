  ...
  return (
    <AppLayout>
      ...
      <section className="flex flex-col items-center justify-center gap-6 min-h-[320px] p-8 text-center">
        ...
        {/* H1 */}
        <h1 className="text-[20px] font-bold text-[#111827] dark:text-white leading-[1.2] tracking-tight">
          Aurora Design System
        </h1>

        {/* Subtitle */}
        <p className="text-[16px] text-[#505867] dark:text-[#9CA3AF] leading-[1.45] tracking-[0.27px]">
      ...
      <section className="mt-12">
        <h2 className="text-[20px] font-bold text-[#111827] dark:text-white leading-[1.15] tracking-[-0.5px]">
          Why Aurora?
        </h2>
        <p className="text-[14px] text-[#505867] dark:text-[#9CA3AF] leading-[1.7] mt-4 max-w-[640px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div>
            <p className="text-[14px] font-semibold text-[#111827] dark:text-white">Consistency at scale</p>
          ...
          <div>
            <p className="text-[14px] font-semibold text-[#111827] dark:text-white">Accessible by default</p>
          ...
          <div>
            <p className="text-[14px] font-semibold text-[#111827] dark:text-white">AI-agent ready</p>
          ...
          <div>
            <p className="text-[14px] font-semibold text-[#111827] dark:text-white">Designed for decisions</p>
