...
export default function PopperPage() {
  return (
    <ComponentPageLayout>
      <TitleBlock
        title="Popper"
        description="Low-level positioning primitive for floating elements. Anchors a panel to a trigger with collision-aware placement. Used internally by Menu, Tooltip, and Combobox."
        status="stable"
        since="1.0.0"
      />
