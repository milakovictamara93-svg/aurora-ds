...
export default function TablePage() {
  return (
    <ComponentPageLayout>
      ...
      <SectionWrapper id="sizes" num="04" total={TOTAL} title="Sizes"><TodoSection label="Tables are full-width. Row height is fixed at 40px." /></SectionWrapper>
      ...
      <SectionWrapper id="anatomy" num="08" total={TOTAL} title="Anatomy"><TodoSection label="Anatomy diagram for Table coming in follow-up." /></SectionWrapper>
    </ComponentPageLayout>
  )
}