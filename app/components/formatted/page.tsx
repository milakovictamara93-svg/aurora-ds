...
export default function FormattedPage() {
  return (
    <ComponentPageLayout>
      <TitleBlock
        title="Formatted"
        description="Renders structured data values with locale-aware formatting: numbers, dates, currencies, and percentages. Wraps Intl APIs with design-system typography."
        status="stable"
        since="1.1.0"
      />
