            ...
            <div className="rounded-lg border border-[#EDEEF1] dark:border-[#1F2430] bg-white dark:bg-[#0D1117] p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[14px] font-medium text-[#111827] dark:text-white truncate">energy-data-2024.csv</p>
                  ...
                  <p className="text-[10px] text-[#505867] dark:text-[#9CA3AF] mt-1">65% uploaded</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-lg border border-[#EDEEF1] dark:border-[#1F2430] bg-white dark:bg-[#0D1117] p-4 flex flex-col gap-2">
              {['energy-data-2024.csv', 'ghg-emissions-q1.xlsx'].map(name => (
                <div key={name} className="flex items-center gap-3">
                  ...
                  <p className="text-[14px] font-medium text-[#111827] dark:text-white flex-1 truncate">{name}</p>
